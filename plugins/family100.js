...
// Command !family100
handler.command = handler.help = ['family100'];
handler.tags = ['game'];
handler.limit = false;
...
// Command !nyerah
let nyerah = async (m, { conn, command }) => {
  conn.family100 = conn.family100 || {};
  let room = conn.family100[m.chat];
...
nyerah.command = nyerah.help = ['nyerah'];
nyerah.tags = ['game'];
nyerah.limit = false;
nyerah.premium = false;

module.exports = [handler, nyerah];
